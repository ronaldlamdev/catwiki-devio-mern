  ...
  return (
    <div className='px-[1.125rem] mt-8'>
      ...
      <div className='w-full relative h-fit'>
        ...
        <div className='flex justify-center flex-col gap-3 h-full absolute top-0 left-7 max-w-[371px] w-[135px] min-[580px]:w-[220px] min-[768px]:w-[300px] min-[900px]:w-[400px]'>
          <div>
            <img src={Logo} className='invert contrast-[150%] min-[580px]:w-full max-w-[310px]' alt='logo'/>
            <h1 className='text-white text-sm min-[580px]:text-base mt-4'>Get to know more about your breed</h1>
          </div>
          <div className='flex'>
            <input type='text' placeholder='Search' className='pl-4 text-sm min-[580px]:text-base rounded-l-3xl max-w-[394px] w-[90px] min-[580px]:w-[180px] min-[768px]:w-[270px] min-[900px]:w-[360px] lg:w-[394px]'/>
